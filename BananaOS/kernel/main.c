 ...
 *****************************************************************************/
void banana_shell(const char * tty_name)
{
	...
	while (1) {
		...
		if (fd == -1) {
			if (rdbuf[0]) {
				if(strcmp(rdbuf, "mkfile") == 0){
				    mkfile();
				}
				else if(strcmp(rdbuf, "editfile") == 0){
				    editfile();
				}
				else if(strcmp(rdbuf, "catfile") == 0){
				    catfile();
				}
				else if(strcmp(rdbuf, "rmfile") == 0){
				    rmfile();
				}
				else if(strcmp(rdbuf, "mkfolder") == 0){
				    mkfolder();
				}
				else if(strcmp(rdbuf, "ls") == 0){
				    ls();
				}
				else if(strcmp(rdbuf, "cdfolder") == 0){
				    cdfolder();
				}
				else if(strcmp(rdbuf, "cdup") == 0){
				    cdup();
				}
...
void cdfolder(){
    printf("Please input the folder NAME: \n");
    char filename[10]={0};
    read(0, filename, 10);
    for(int i=fs[nowfolder].firstchild; i!=-1;i=fs[i].nextsibling){
...
void help()
{
	...
	printf("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
	printf("        animation          |           Play the welcome anime\n");
	printf("        ls                 |           List all files in current folder\n");
	printf("        help               |           List all commands\n");
	printf("        mineSweeping       |           Start GAME Mine Sweeping\n");
	printf("        Boxman             |           Start GAME Boxman\n");
	printf("        getDate            |           Start APP Date Calculator\n");
        printf("        cdfolder           |           Open a folder\n");
	printf("        calculator         |           Start APP Floating Point Calculator\n");
	printf("        mkfile             |           Create a new file\n");
	printf("        mkfolder           |           Create a new folder\n");
	printf("        catfile            |           Read a file\n");
	printf("        rmfile             |           Delete a file\n");
	printf("        editfile           |           Edit file, cover the content\n");
	printf("        cdup               |           return to the parent folder\n");
	printf("********************************************************************************\n");
...
printf("                           .....,@\oooooooo^....*,/@/[[[[[[.            \n");
printf("                           ....,@Oooooooooo^...*/@@\/\//\@\`            \n");
printf("                          ....=@ooooooooooo`.,/OOOOOO@@@O\`@            \n");
printf("                       ......@@ooooooooooo^/OOOOO@@[.....\@\            \n");
printf("                       ..../@/oooooooooooOOOOO@@[...........            \n");
printf("           ..............,@/ooooooooooooOOOOO@^.......... ..            \n");
printf("           ...........,/@O/oooooooooooOOOOO@/.......                    \n");
printf("           ........,@@OoooooooooooooOOOOOO@`.......                     \n");
printf("           .....]@@O\/oooooooooooooOOOOO@/.........                     \n");
printf("           ..,@@\\ooooooooooooooOOOOOO@/....                            \n");
...
PUBLIC void welcome()
{
	...
	printf("            ******************************************************\n");
	printf("            *                                                    *\n");
	printf("            *        Welcome to the Banana Operating System      *\n");
	printf("            *                                                    *\n");
	printf("            ******************************************************\n");
	printf("            *                                                    *\n");
	printf("            *                                                    *\n");
	printf("            *                1552683 Sun Xiaoqing                *\n");
	printf("            *                                                    *\n");
	printf("            *                                                    *\n");
	printf("            ******************************************************\n\n");
}
